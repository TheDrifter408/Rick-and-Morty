  ...
  return (
    <Box styles="-translate-x-full opacity-0">
      ...
      <section className="w-5/6 my-4 mx-auto">
          ...
          <p>The series addresses the insignificance of human existence as compared to the size of the universe, with no recognizable divine presence, as described by <a className="font-semibold underline">Lovecraft</a>'s philosophy of <a className="font-semibold underline">cosmicism</a>.</p>
      </section>
      <section className="w-5/6 my-4 mx-auto">
