  ...
  return (
    <Box styles="-translate-x-full opacity-0">
      ...
      <section className="w-5/6 mx-auto">
          ...
          <p>Rick and Morty is an American animated science fiction show created by <a className="font-semibold underline" href="https://en.wikipedia.org/wiki/Justin_Roiland">Justin Roiland</a> and <a className="font-semibold underline" href="https://en.wikipedia.org/wiki/Dan_Harmon">Dan Harmon</a> for <a className="font-semibold underline" href="https://en.wikipedia.org/wiki/Cartoon_Network">Cartoon Network</a>'s nighttime programming block <a className="font-semibold underline" href="https://en.wikipedia.org/wiki/Adult_Swim">Adult Swim</a>.The series follows the misadventures of Rick Sanchez, a cynical mad scientist, and his good-hearted but fretful grandson Morty Smith, who split their time between domestic life and interdimensional adventures that take place across an infinite number of realities, often traveling to other planets and dimensions through portals and on Rick's flying saucer.</p>
