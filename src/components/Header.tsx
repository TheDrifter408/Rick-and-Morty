...
export default function Header(){
    return(
        <Box styles="-translate-y-full opacity-0">
            <header className="fixed z-50 w-full top-0 right-0 left-0 bg-white flex justify-between py-2 px-4 h-[3rem] border-b-2 border-slate-300 shadow-sm shadow-slate-300/100">
            <div className="ml-2">
